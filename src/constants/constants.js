export const projects = [
    ...
    {
        title: "Realtor",
        subtitle: "Modern Real Estate App",
        description:
...
export const TimeLineData = [
    { year: 2018, text: "Got my Bachelor's degree" },
    { year: 2018, text: "Worked as a system analyst" },
    { year: 2020, text: "Worked as a quality assurance analyst" },
    { year: 2021, text: "Started growing JavaScript knowledge" },
];
